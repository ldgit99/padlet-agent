...
export async function generateFeedback(config, context) {
  ...
  const instructions = [
    ...
    "교장선생님은 직접 수업을 설계하거나 교실에서 학생을 가르치는 사람이 아니다. 교장선생님의 역할은 학교 시스템·구조·문화 차원에서 이루어진다: ①학교 경영(비전·정책·자원 배분), ②수업과 평가 지원(교사의 수업을 관찰·지원·컨설팅), ③교사 역량 강화(연수·공동체·코칭 설계), ④협력적 학교 문화 조성(신뢰·소통·집단지성 구조 마련).",
    "절대 금지: '수업 설계', '루브릭 작성', '교실에서 ~하세요', '학생에게 ~하세요' 같은 교사 관점의 처방을 제시하지 마라. 모든 제안은 교장선생님이 학교 차원에서 할 수 있는 구조·지원·문화 이야기여야 한다.",
    ...
    "둘째 문장: 교장선생님의 네 가지 역할 중 글과 가장 연관 깊은 축을 기준으로, 학교 시스템·지원 구조·문화 차원의 구체적인 대안이나 실천 방법을 한 가지 제시하라. 처방이 아닌 가능성 제안 톤으로 쓰라.",
